...
public class Shipment {
    ...
    public void show_infos() {
        ...
        System.out.println("Number : " + getShip_number());
        System.out.println("Sender : " + getSender());
        System.out.println("Reciever : " + getReceiver());
        System.out.println("Branch Status : " + getBranch_status());
        System.out.print("Delivered Status : ");
        if (getDelivered_status()) System.out.println("DELIVERED");
        else System.out.println("NOT DELIVERED");
        System.out.println("\n");
    }
